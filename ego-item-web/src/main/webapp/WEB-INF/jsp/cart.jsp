		        ...
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-goods">
		                <div class="p-img">
		                	<a href="/item/${cart.value.item.id}.html" target="_blank">
		                		<img clstag="clickcart|keycount|xincart|p-imglistcart" src="${cart.value.item.images[0]}" alt="${cart.value.item.title}" width="52" height="52">
		                	</a>
		                </div>    
		                <div class="p-name">
		                	<a href="/item/${cart.value.item.id}.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">${cart.value.item.title}</a>
		            ...
		            <div class="cell p-quantity" for-stock="for-stock-11345721">
		                <div class="quantity-form" data-bind="">
		                    ...
		                    <input type="text" class="quantity-text" itemPrice="${cart.value.item.price}" itemId="${cart.value.item.id}" value="${cart.value.num}" id="changeQuantity-11345721-1-1-0">
		                    <a href="javascript:void(0);" class="increment" clstag="clickcart|keycount|xincart|add1" id="increment">+</a>
		                </div>
		            </div>
		            <div class="cell p-remove"><a id="remove-11345721-1" data-more="removed-87.20-1" clstag="clickcart|keycount|xincart|btndel318558" class="cart-remove" href="/cart/delete/${cart.value.item.id}.html">删除</a>
		            </div>
		        </div>
	        </div> 
        </c:forEach>
